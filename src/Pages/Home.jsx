...
import SongsCarousal2 from './songCarousal2';
...
const Home = () => {
  return (
    <Box px='4px' h='1332px'>
        ...
        <Flex justifyContent='space-between' alignItems='center' bgColor='#202022' w='366px' h='40px' m='auto' p='9px 16px'>
        ...
        <Heading fontSize='22px' color={'white'} mb='4px' mt='40px'>Songs for you</Heading>
        ...
        <Text color='white' fontSize='14px' letterSpacing={'0.2px'} lineHeight='22px' mb='16px' opacity={0.6}>Listen to the songs from my collection.</Text>
        <SongsCarousal />
        <Heading fontSize='22px' color={'white'} mb='4px' mt='40px'>Tweet Shorts</Heading>
        <Text color='white' fontSize='14px' letterSpacing={'0.2px'} lineHeight='22px' mb='16px' opacity={0.6}>Listen to audio versions of tweet threads.</Text>
        <SongsCarousal2 />
    </Box>
  )
}
